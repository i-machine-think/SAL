...
class TestSender(unittest.TestCase):
    ...
    @mock.patch('machine.models.Sender.gumbel_softmax')
    def test_lstm_bound_sos_train(self, mock_gumbel):
        sender = Sender(self.vocab_size, self.max_len, self.embedding_size,
                     self.hidden_size, self.sos_id, self.sos_id, 
                     rnn_cell='lstm', greedy=True)
    ...
    @mock.patch('machine.models.Sender.F.softmax')
    def test_lstm_bound_sos_eval(self, mock_softmax):
        sender = Sender(self.vocab_size, self.max_len, self.embedding_size,
                     self.hidden_size, self.sos_id, self.sos_id, 
                     rnn_cell='lstm', greedy=True)
        ...
        self.assertEqual(seq_lengths[0], 4)
        self.assertEqual(seq_lengths[1], 2)